...
module.exports = function () {
    ...
    validators.errMessages = {
        ...
        url: 'Invalid URL',
        match: _.template('Must match field "<%= field %>"', null,TemplateSettings),
    };
    ...
    validators.range = function (options) {
        ...
        return function range(value) {
            ...
            let numberCheck = validators.number({ message: options.numberMessage })(value);
            if (numberCheck) return numberCheck;

            // check value is in range
            let number = parseFloat(options.value);
