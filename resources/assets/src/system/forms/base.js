...
module.exports = Backbone.View.extend(
    {
        ...
        initialize: function (options) {
            ...
            let selectedFields = (this.selectedFields = options.fields || _.keys(schema));
            ...
            //Create fieldsets
            let fieldsetSchema = options.fieldsets ||
                    _.result(this, 'fieldsets') ||
                    _.result(this.model, 'fieldsets') || [selectedFields],
        ...
        createField: function (key, schema) {
            ...
            let field = new this.Field(options);
        ...
        handleEditorEvent: function (event, editor) {
            ...
            let formEvent = editor.key + ':' + event;
            ...
            switch (event) {
                ...
                case 'blur':
                    ...
                    if (this.hasFocus) {
                        ...
                        let self = this;
                        setTimeout(function () {
                            let focusedField = _.find(self.fields, function (field) {
        ...
        render: function () {
            ...
            //Render form
            let $form = $($.trim(this.template(_.result(this, 'templateData'))));
        ...
        commit: function (options) {
            ...
            let errors = this.validate(validateOptions);
            if (errors) return errors;

            //Commit
            let modelError;

            let setOptions = _.extend(
                {
