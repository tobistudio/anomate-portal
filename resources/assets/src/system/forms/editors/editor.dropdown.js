...
require('@/system/plugins/chosen.jquery');
...
module.exports = Form.editors.Base.extend({
    ...
    renderOptions: function (options) {
        ...
        let EditorAttributes = this.schema.editorAttrs;
        
        console.log(EditorAttributes);
        
        //Insert options
        $select.html(html).ready(function(e){
            $select.chosen(EditorAttributes); 
        });
