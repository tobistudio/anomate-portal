/*
 * rmNotify | v1.4.0
 * http://rmNotify.marcelodolce.com
 * by Marcelo Dolce.
 */
(function (root, factory) {
    ...
    $rmNotify.setSetting = function (ref, option, value) {
        $rmNotify.children[ref][option] = value;
    };

    $rmNotify.getSetting = function (ref, option) {
        return $rmNotify.children[ref][option];
    };
     ...
     */
    $rmNotify.settings = function (options) {
    ...
    forEach(THEMES, function (theme, name) {
        $rmNotify[name] = function (options) {
     ...
     * @private
     */
    $rmNotify.progress = function (options, $toast, callback) {
        var that = this,
            ref = $toast.getAttribute('data-rmNotify-ref'),
                ...
                if (typeof settings.time.REMAINING == 'undefined') {
                    ...
                    if ($elem !== null) {
                        $elem.style.transition =
                            'width ' + settings.timeout + 'ms ' + settings.progressBarEasing;
                        $elem.style.width = '0%';
                    }
     ...
     * @param {Object} options User settings
     */
    $rmNotify.hide = function (options, $toast, closedBy) {
        ...
        var that = this,
            settings = extend(
                this.children[$toast.getAttribute('data-rmNotify-ref')],
                options || {}
            );
        ...
        (function () {
            ...
            if ($overlay !== null) {
                var refs = $overlay.getAttribute('data-rmNotify-ref');
                refs = refs.split(',');
                ...
                $overlay.setAttribute('data-rmNotify-ref', refs.join());
     ...
     * @param {Object} options User settings
     */
    $rmNotify.show = function (options) {
        var that = this;
        ...
        $rmNotify.children[settings.ref] = settings;
        ...
        $DOM.toast.setAttribute('data-rmNotify-ref', settings.ref);
        ...
        (function () {
            ...
            if (settings.target) {
                ...
                if (POSITIONS.indexOf(settings.position) == -1) {
                    console.warn(
                        '[' + PLUGIN_NAME + '] Incorrect position.\nIt can be › ' + POSITIONS
                    );
                    return;
                }
            ...
            if (settings.overlay) {
                if (document.querySelector('.' + PLUGIN_NAME + '-overlay.fadeIn') !== null) {
                    ...
                    $DOM.overlay.setAttribute(
                        'data-rmNotify-ref',
                        $DOM.overlay.getAttribute('data-rmNotify-ref') + ',' + settings.ref
                    );
                    ...
                    $DOM.overlay.setAttribute('data-rmNotify-ref', settings.ref);
                    if (!isNaN(settings.zindex) && settings.zindex !== null) {
                        $DOM.overlay.style.zIndex = settings.zindex - 1;
                    }
